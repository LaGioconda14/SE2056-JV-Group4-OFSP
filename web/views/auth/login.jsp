...
<head>
    ...
    <title>Đăng nhập - FreshFruit Platform</title>
    ...
    <div class="form-panel">
        <div>
            ...
            <div class="social-btn-group">
                <a href="#" class="social-btn" onclick="alert('Đăng nhập Google đang phát triển'); return false;">
                ...
                <a href="#" class="social-btn" onclick="alert('Đăng nhập Apple đang phát triển'); return false;">
            ...
            <form action="${pageContext.request.contextPath}/login" method="POST" id="loginForm">
                ...
                <div class="field-group">
                    ...
                    <div class="input-box-wrapper">
                        ...
                        <span class="trailing-action" onclick="togglePasswordVisibility('password', this)" title="Ẩn/Hiện mật khẩu">
                            <i class="bi bi-eye"></i>
                        </span>
                    </div>
                </div>
        ...
        <div class="test-state-bar">
            ...
            <div class="test-state-links">
                <a href="${pageContext.request.contextPath}/login" class="test-state-pill active">Sign In</a>
