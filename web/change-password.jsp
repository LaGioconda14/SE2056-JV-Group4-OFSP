...
<head>
    ...
    <title>Đổi mật khẩu - Online Fruit Shop</title>
    <!-- Bootstrap 5 CSS -->
...
<div class="auth-card">
    <div class="auth-header">
        ...
        <p class="text-white-50 small mb-0">Cập nhật mật khẩu để bảo vệ tài khoản của bạn</p>
    </div>
    ...
    <div class="p-4 pt-3">
        ...
        <c:if test="${not empty sessionScope.user}">
            <div class="user-badge">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div>
                        <strong class="d-block">${sessionScope.user.fullName}</strong>
                        <span class="text-muted small">${sessionScope.user.email}</span>
                    </div>
                </div>
        ...
        <form action="${pageContext.request.contextPath}/change-password" method="POST">
            <!-- Mật khẩu hiện tại -->
            <div class="mb-3">
                <label for="oldPassword" class="form-label small fw-semibold text-secondary">Mật khẩu hiện tại</label>
                <div class="input-group">
                    ...
                    <input type="password" 
                           ...
                           required 
                           autofocus>
                    <span class="input-group-text password-toggle" onclick="togglePasswordVisibility('oldPassword', this)">
                        <i class="bi bi-eye"></i>
                    </span>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between align-items-center pt-2">
                <a href="${pageContext.request.contextPath}/home.jsp" class="auth-link small d-inline-flex align-items-center gap-1">
                    <i class="bi bi-house-door"></i>
                    <span>Trang chủ</span>
                </a>
                <a href="${pageContext.request.contextPath}/logout" class="text-danger text-decoration-none small d-inline-flex align-items-center gap-1">
